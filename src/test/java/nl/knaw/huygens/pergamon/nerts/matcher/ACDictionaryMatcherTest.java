...
public class ACDictionaryMatcherTest {

  private MatcherFactory factory;

  @Before
  public void setup() {
    factory = new MatcherFactory(MatcherType.AHO_CORASICK_MATCHER);
  }
  ...
  public void testOverlappingMatch() {
    testMatches(1, "Isle de Re", "Notre ami de l'Isle de Re.", "l'Isle", "Isle de Re");
  }
